# ========================================================================
# Special Deployment Parameters needed for the onbis-x-proxy instance.
# ------------------------------------------------------------------------
...
CONFIG_MAP_NAME=onbis-x-proxy-caddy-conf
SOURCE_FILE=../caddy/Caddyfile
OUTPUT_FORMAT=json
OUTPUT_FILE=onbis-x-proxy-caddy-configmap_DeploymentConfig.json
...
SPECIALDEPLOYPARMS="-p AGENT_USER=${_userName} -p AGENT_PASSWORD=${_password}"
